...
public class EntityUtil {
    ...
    private final String moduleName = "db2022"; // 数据库名称

    private final String bean_path = "D:\\Code\\IDEA\\project\\seckill\\seckill-service\\src\\main\\java";

    private final String mapper_path = "D:\\Code\\IDEA\\project\\seckill\\seckill-service\\src\\main\\java\\com\\study\\seckill\\dao";

    private final String xml_path = "D:\\Code\\IDEA\\project\\seckill\\seckill-service\\src\\main\\resources\\mapping";// xml路径

    private final String model_package = "com.study.seckill.model";// model的包所在

    private final String dao_package = "com.study.seckill.dao";// dao的包所在

    private final String driverName = "com.mysql.cj.jdbc.Driver";

    private final String user = "root";// 数据库用户

    private final String password = "123123";// "root";//数据库密码

    private final String url = "jdbc:mysql://localhost:3306/" + moduleName + "?useSSL=false&charset=utf8mb4&serverTimezone=Hongkong";
    ...
    private void buildMapper(List<String> columns, List<String> types) throws IOException {
        ...
        bw.newLine();
        bw.write("import com.study.seckill.common.util.bean.CommonQueryBean;");
        bw.newLine();
        bw.newLine();
