package com.study.seckill.common.util.http;
...
public class HttpClientUtil {
    ...
    /**
     * 带参数的resfful风格的post请求，即body整体为一个json数据.
     */
    public HttpResult doBodyPost(String url, Map<String, Object> map) throws Exception {
        // 声明httpPost请求
        HttpPost httpPost = new HttpPost(url);
        String requsetbody = "";
